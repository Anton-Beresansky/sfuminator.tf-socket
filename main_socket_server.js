...
var httpListenPort = CFG.http_listen_port; //dev ***REMOVED*** | main ***REMOVED***
var socketPorts = {connect: CFG.cloud_ports.connect, listen: CFG.cloud_ports.listen}; //main ***REMOVED***,***REMOVED*** | dev ***REMOVED***,***REMOVED***
