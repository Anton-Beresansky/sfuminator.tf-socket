...
function SteamTradeOffer(steamClient, partnerSteamID) {
     ...
     * @type {Logs}
     */
    this.log = new Logs({applicationName: "STO " + this.steamClient.getCredentials().getUsername() + " > " + this.partnerSteamID, color: "green", dim: false});
